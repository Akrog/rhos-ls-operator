...
// buildConsoleServiceSpec builds the Service spec for the console plugin.
func buildConsoleServiceSpec() corev1.ServiceSpec {
	return corev1.ServiceSpec{
		...
		Selector: generateConsoleSelectorLabels(),
